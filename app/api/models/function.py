...
class FunctionDefinition(BaseModel):
    ...
    """
    id: UUID = Field(default_factory=uuid4, description="The unique identifier of the function")
    ...
    implementation: Optional[Callable] = Field(None, description="The actual implementation of the function")
...
class FunctionRegistrationResponse(BaseModel):
    ...
    """
    function_id: UUID = Field(..., description="The unique identifier assigned to the registered function", example="3fa85f64-5717-4562-b3fc-2c963f66afa6")
...
class FunctionUpdateRequest(BaseModel):
    ...
    """
    function_id: UUID = Field(..., description="The unique identifier of the function to update", example="3fa85f64-5717-4562-b3fc-2c963f66afa6")
...
class FunctionUpdateResponse(BaseModel):
    ...
    """
    function_id: UUID = Field(..., description="The unique identifier of the updated function", example="3fa85f64-5717-4562-b3fc-2c963f66afa6")
...
class FunctionAssignmentRequest(BaseModel):
    ...
    function_id: UUID = Field(..., description="The ID of the function to assign", example="3fa85f64-5717-4562-b3fc-2c963f66afa6")
...
class FunctionAssignmentResponse(BaseModel):
    ...
    """
    agent_id: UUID = Field(..., description="The ID of the agent", example="3fa85f64-5717-4562-b3fc-2c963f66afa6")
    function_id: UUID = Field(..., description="The ID of the function", example="3fa85f64-5717-4562-b3fc-2c963f66afa6")
